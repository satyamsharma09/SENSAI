// app/resume/_components/ResumeBuilder.jsx
"use client";
...
import { saveResume, improveWithAI } from "@/actions/resume"; // Import improveWithAI action
...
export default function ResumeBuilder({ initialContent }) {
  ...
  const {
    loading: isImprovingSummary, // Separate loading state for summary
    fn: improveWithAISummaryFn, // Separate improve function for summary
  ...
  useEffect(() => {
    ...
    if (improveSummaryError) {
      toast.error(
        improveSummaryError.message || "Failed to improve professional summary"
      );
    }
  ...
  const handleImproveSummary = async () => {
    ...
    await improveWithAISummaryFn({ current: summary, type: "summary" });
  };
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="edit">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                  ...
                  <Input
                    {...register("contactInfo.mobile", {
                      ...
                      pattern: {
                        value: /^\+91[0-9]{10}$/,
                        message:
                          "Invalid mobile format. Must be +91 followed by 10 digits",
                      },
                    })}
                    type="text"
                    ...
                    onInput={(e) => {
                      // restrict input to + and digits only
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    {...register("contactInfo.twitter", {
                      required: "Twitter/X URL is required",
                      pattern: {
                        value: /^https?:\/\/.+$/,
                        message: "URL must start with http:// or https://",
                      },
            ...
            {/* Summary with Improve AI Button */}
            <div className="space-y-4">
